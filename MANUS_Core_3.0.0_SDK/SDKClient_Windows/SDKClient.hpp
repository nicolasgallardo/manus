...
protected:
	...
	virtual ClientReturnCode DisplayingRunSurge();
	virtual ClientReturnCode DisplayingCalibrateSurge();
	...
	//-----------------------------------------Alt-Bioinics: SERIAL--------------------------------------------------
	//***************************************************************************************************************
	void getErgo(ErgonomicsData& p_ErgoData, float* angles, bool p_Left);
	void RunSurge(ErgonomicsData& p_ErgoData, bool p_Left);
	void CalibrateSurge();
	//***************************************************************************************************************
